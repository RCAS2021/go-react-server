...
import (
	...
	"github.com/RCAS2021/go-react-server/internal/store/pgstore"
...
func (h apiHandler) getRoomIDAndValidate(w http.ResponseWriter,
	r *http.Request,
...
func (h apiHandler) handleSubscribe(w http.ResponseWriter, r *http.Request) {
	_, rawRoomID, _, ok := h.getRoomIDAndValidate(w, r)
	if !ok {
		return
	}
	...
	if err != nil {
		...
		http.Error(w, "failed to upgrade the web socket connection", http.StatusBadRequest)
		return
	}
...
func (h apiHandler) handleGetRoom(w http.ResponseWriter, r *http.Request) {
	room, _, _, ok := h.getRoomIDAndValidate(w, r)
	if !ok {
		return
	}
...
func (h apiHandler) handleCreateRoomMessage(w http.ResponseWriter, r *http.Request) {
	_, rawRoomID, roomID, ok := h.getRoomIDAndValidate(w, r)
	if !ok {
		return
	}
...
func (h apiHandler) handleGetRoomMessages(w http.ResponseWriter, r *http.Request) {
	_, _, roomID, ok := h.getRoomIDAndValidate(w, r)
	if !ok {
		return
	}
...
func (h apiHandler) getMessageIDAndValidate(w http.ResponseWriter,
	r *http.Request,
...
func (h apiHandler) handleGetRoomMessage(w http.ResponseWriter, r *http.Request) {
	_, _, _, ok := h.getRoomIDAndValidate(w, r)
	if !ok {
		return
	}

	message, _, _, ok := h.getMessageIDAndValidate(w, r)
	if !ok {
		return
	}
